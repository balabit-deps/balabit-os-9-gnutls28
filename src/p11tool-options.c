...
struct p11tool_opts p11toolOptions;
...
int
optionProcess (struct p11tool_opts *opts, int argc, char **argv)
{
  int opt;
      ...
      if (!OPT_ARG_VERSION || !strcmp (OPT_ARG_VERSION, "c"))
      ...
      else if (!strcmp (OPT_ARG_VERSION, "n"))
        {
          const char str[] =
            ...
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n"
            "\n"
            "p11tool is free software: you can redistribute it and/or\n"
            "modify it under the terms of the GNU General Public License\n"
            "as published by the Free Software Foundation,\n"
            "either version 3 of the License, or (at your option) any later version.\n"
            "\n"
            "p11tool is distributed in the hope that it will be useful,\n"
...
usage (FILE *out, int status)
{
  const char str[] =
    ...
    "				- disabled as '--no-mark-always-authenticate'\n"
